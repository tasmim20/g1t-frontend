...
import { DriverProfile } from "@/src/types"; // reuse type, role will be DRIVER
import { Toaster } from "react-hot-toast";
import ResetDriverPassword from "./profile/ResetPassword";
import DeleteProfile from "./profile/DeleteProfile";
import UpdateDriverProfile from "./profile/UpdateProfile";
...
const DriverDashboard = () => {
  ...
  const handleProfileUpdate = (updated: Partial<DriverProfile>) => {
    setProfile((prev) => ({
      ...prev!,
      ...updated,
    }));
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md border border-gray-200 relative">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        ...
        <div className="p-4 bg-green-50 rounded-lg text-center">
          <p className="text-sm text-gray-500">DrivingLicense</p>
          <p className="font-bold text-lg">{profile.drivingLicense || "-"}</p>
        </div>
        <div className="p-4 bg-blue-50 rounded-lg text-center">
